...
class Product_Comparison_Woocommerce_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Product_Comparison_Woocommerce_About_Widget',
			__('VW About us', 'product-comparison-woocommerce'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'product-comparison-woocommerce' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','product-comparison-woocommerce'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','product-comparison-woocommerce'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','product-comparison-woocommerce'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','product-comparison-woocommerce'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','product-comparison-woocommerce'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','product-comparison-woocommerce'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function product_comparison_woocommerce_about_custom_load_widget() {
	register_widget( 'Product_Comparison_Woocommerce_About_Widget' );
}
add_action( 'widgets_init', 'product_comparison_woocommerce_about_custom_load_widget' );