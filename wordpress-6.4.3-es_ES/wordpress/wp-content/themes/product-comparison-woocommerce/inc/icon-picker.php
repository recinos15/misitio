...
class Product_Comparison_Woocommerce_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'product-comparison-woocommerce' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $product_comparison_woocommerce_font_awesome_icon_array = product_comparison_woocommerce_font_awesome_icon_array();
                    foreach ($product_comparison_woocommerce_font_awesome_icon_array as $product_comparison_woocommerce_font_awesome_icon) {
                            $icon_class = $this->value() == $product_comparison_woocommerce_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($product_comparison_woocommerce_font_awesome_icon).'"></i>
                            <span class="product-comparison-woocommerce-social-class">'.esc_attr($product_comparison_woocommerce_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function product_comparison_woocommerce_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'product-comparison-woocommerce-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'product_comparison_woocommerce_customizer_script' );

if(!function_exists('product_comparison_woocommerce_font_awesome_icon_array')){
    function product_comparison_woocommerce_font_awesome_icon_array(){
