...
if ( ! class_exists( 'Product_Comparison_Woocommerce_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Product_Comparison_Woocommerce_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Product_Comparison_Woocommerce_WPTT_WebFont_Loader( $url );
