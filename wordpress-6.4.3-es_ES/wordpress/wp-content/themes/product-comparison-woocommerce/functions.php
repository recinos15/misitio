...
function product_comparison_woocommerce_activation_notice() {
	...
	echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=product_comparison_woocommerce_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'product-comparison-woocommerce' ) .'</a></span>';
	...
	echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/themes/price-comparison-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'product-comparison-woocommerce' ) .'</a></span>';
	echo '</div>';
}
...
define('PRODUCT_COMPARISON_WOOCOMMERCE_BUY_NOW',__('https://www.vwthemes.com/themes/price-comparison-wordpress-theme/','product-comparison-woocommerce'));
...
define('PRODUCT_COMPARISON_WOOCOMMERCE_CREDIT',__('https://www.vwthemes.com/themes/free-product-comparison-wordpress-theme/','product-comparison-woocommerce'));
